...
- **Once Channel is created you would be able to view your temperature and humidity data in private view with Fields you created inside the Channel.**
...
- **To plot a graph between  humidity and temp data ,you can use MATLAB Visualization.**
